...
namespace Hado.PL.Forms.Exam
{
    public partial class _CreateExam : Form
    {
        ...
        int klasik, secmeli, dogruyanlis, bosluk=0;
        ...
        private void btnCreate_Click(object sender, EventArgs e)
        {
            ...
            {
                CreateWordDocument(@"C:\Projects\HadoSystem\Hado.PL\Resources\SinavKagidi.docx", @"C:\Users\Eren\Desktop\SinavkagidiA.docx");
                CreateWordAnswers(@"C:\Projects\HadoSystem\Hado.PL\Resources\SinavKagidi.docx", @"C:\Users\Eren\Desktop\SinavkagidiACevap.docx");
            ...
            else if (cmbBoxGroupNumber.SelectedItem.ToString() == "2")
            {
                ...
                CreateWordDocument(@"C:\Projects\HadoSystem\Hado.PL\Resources\SinavKagidi.docx", @"C:\Users\Eren\Desktop\SinavkagidiB.docx");
                CreateWordAnswers(@"C:\Projects\HadoSystem\Hado.PL\Resources\SinavKagidi.docx", @"C:\Users\Eren\Desktop\SinavkagidiBCevap.docx");
            ...
            else if (cmbBoxGroupNumber.SelectedItem.ToString() == "3")
            {
                ...
                CreateWordDocument(@"C:\Projects\HadoSystem\Hado.PL\Resources\SinavKagidi.docx", @"C:\Users\Eren\Desktop\SinavkagidiC.docx");
                CreateWordAnswers(@"C:\Projects\HadoSystem\Hado.PL\Resources\SinavKagidi.docx", @"C:\Users\Eren\Desktop\SinavkagidiCCevap.docx");
            ...
            else if (cmbBoxGroupNumber.SelectedItem.ToString() == "4")
            {
                ...
                CreateWordDocument(@"C:\Projects\HadoSystem\Hado.PL\Resources\SinavKagidi.docx", @"C:\Users\Eren\Desktop\SinavkagidiD.docx");
                CreateWordAnswers(@"C:\Projects\HadoSystem\Hado.PL\Resources\SinavKagidi.docx", @"C:\Users\Eren\Desktop\SinavkagidiDCevap.docx");
                    ...
                    if (questionViewModels.Where(y => y.QuestionType == 2).ToList().Count() == bosluk)
                    {
                        ...
                        foreach (var item in questionViewModels.Where(z => z.QuestionType == 2).ToList())
                        {
                            ...
                            if (sayacc == bosluk)
                            {
                                ...
                                for (int i = 0; i < dizi.Length; i++)
                                {
                                    if (dizi[i] != null || string.IsNullOrEmpty(dizi[i])==false)
                                    {
